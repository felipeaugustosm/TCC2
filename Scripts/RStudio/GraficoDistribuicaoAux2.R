...
#plot(ditTradicionais.ecdf, verticals=TRUE, do.points=FALSE, col="yellow", ylab="Distribuição", xlab="Métrica LOC Kotlin",las=1, main="", xlim = c(0, 5))
plot(ditTradicionais.ecdf, verticals=TRUE, do.points=FALSE, col="yellow", ylab="Distribuição", xlab="Métrica LOC (Média por pacote)",las=1, main="", xlim = c(0, 25000))
