...
path="C:/Users/felip/Documents/TCC2/Resultados/Graficos/Distribuicao/"
extensao=".jpeg"
...
for(metric in 17:17){
  ...
  jpeg(filename = pathnameFile, width = 1000, height = 1000)
    ...
    plot(ditTradicionais.ecdf, verticals=TRUE, do.points=FALSE, col="yellow", ylab="Distribuição", xlab="Métrica DIT",las=1, main="", cex.axis = 2, cex.lab=2.5, xlim = c(0, 4))
